...
const PreviousYearChiefGuest = () => {
  return (
    <Grid container className='h-full m-8' lg={8} md={9} sm={10}>
      ...
      <Grid item className='md:w-9/12 w-full bg-blue-500'>
        <div className='px-8 py-4 text-left text-justify'>
          <Typography variant='subtitle1'>
            ...
            Recusandae aliquid error eos, nam in laboriosam totam.Lorem ipsum,
            dolor sit amet consectetur adipisicing elit. Voluptates officia
            dolores id illo, dolore neque necessitatibus dolorum iure sapiente
            ab doloribus explicabo? Recusandae aliquid error eos, nam in
            laboriosam totam.
          </Typography>
        </div>
      </Grid>
